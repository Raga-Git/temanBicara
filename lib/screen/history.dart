                        ...
                        children: [
                          ...
                          Container(
                            ...
                            decoration: BoxDecoration(
                              ...
                              color: Color(0xFF9AD567).withOpacity(0.3),
                            ),
                            child: Padding(
                  ...
                  Container(
                    ...
                    child: Center(
                      child: Column(
                        children: [
                          SizedBox(height: 10),
                          Text("Butuh bantuan tenaga ahli ?",
                              style: TextStyle(
                                  fontFamily: 'Poppins',
                                  fontWeight: FontWeight.bold,
                                  fontSize: 15)),
                          ...
                          SizedBox(height: 10),
                          Text("Layanan kesehatan mental terdekat :",
                              style: TextStyle(
                          ...
                          SizedBox(height: 20),
                          Text("Hotline Kesehatan Jiwa Kemenkes :",
                              style: TextStyle(
                                  fontFamily: 'Poppins', fontSize: 15)),
                          Text("021-500-454",
                              style: TextStyle(
